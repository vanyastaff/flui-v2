...
- **K99 → K15 → K07 → K05 → K01 → K02 → K03 → K04**: Phase 0-K critical chain. Sequential. K99, K15, K07, K05, K01, and K02 are complete; K03 is next. Gates all SF specs.
