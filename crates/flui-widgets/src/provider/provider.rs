use flui_core::{AnyElement, App, IntoElement, RenderOnce, Window};
...
impl<T: InheritedValue> flui_core::Element for ProviderElement<T> {
    type RequestLayoutState = ();
    type PrepaintState = ();

    fn id(&self) -> Option<flui_core::ElementId> {
        None
    }
    ...
    fn request_layout(
        &mut self,
        _id: Option<&flui_core::GlobalElementId>,
        _inspector_id: Option<&flui_core::InspectorElementId>,
        window: &mut Window,
        cx: &mut App,
    ) -> (flui_core::LayoutId, Self::RequestLayoutState) {
    ...
    fn prepaint(
        ...
        _id: Option<&flui_core::GlobalElementId>,
        _inspector_id: Option<&flui_core::InspectorElementId>,
        _bounds: flui_core::Bounds<flui_core::Pixels>,
...
impl<T: InheritedValue> flui_core::IntoElement for ProviderElement<T> {
    type Element = Self;
