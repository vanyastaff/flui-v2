...
///     .child("Settings")
///     .active_class(|div| div.text_color(flui_core::rgb(0x21_96_f3)))
///     .build(cx)
/// ```
#[must_use]
...
/// ```ignore
/// DefaultPages::new()
///     .with_not_found(|| flui_core::div().child("Custom 404").into_any_element())
///     .with_error(|msg| flui_core::div().child(msg.to_string()).into_any_element())
/// ```
#[must_use]
