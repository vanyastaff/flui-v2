...
//!
//! ```no_run
//! use flui_navigator::{Route, render_router_outlet};
//! use flui_core::*;
//!
...
///
/// ```
/// use flui_navigator::{NamedRouteRegistry, RouteParams};
///
...
fn get_or_create_cached_component<T: Render + 'static>(
    ...
    let entity: flui_core::Entity<T> = cx.new(|_| create());
...
impl Route {
    ...
    ///
    /// ```no_run
    /// use flui_navigator::{Route, RouteParams};
    /// use flui_core::*;
    ///
    /// struct UserPage {
    ///     user_id: String,
    ...
    ///
    /// ```no_run
    /// use flui_navigator::{Route, AuthGuard, RoleGuard};
    /// use flui_core::*;
    ///
    ...
    ///
    /// ```no_run
    /// use flui_navigator::{Route, RouteLifecycle, NavigationRequest};
    /// use flui_core::*;
    /// use std::pin::Pin;
    ...
    /// # Example
    /// ```no_run
    /// use flui_navigator::{Route, Transition};
    /// use flui_core::*;
    ///
...
/// ```ignore
/// use flui_navigator::{Navigator, PageRoute};
///
/// // String path
...
///
/// ```ignore
/// use flui_navigator::{Navigator, NamedRoute, RouteParams};
///
/// let mut params = RouteParams::new();
