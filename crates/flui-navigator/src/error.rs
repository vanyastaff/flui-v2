...
//!
//! ```
//! use flui_navigator::error::NavigationResult;
//!
...
///
/// ```ignore
/// use flui_navigator::error::ErrorHandlers;
///
/// let handlers = ErrorHandlers::new()
///     .on_not_found(|cx, path| {
///         flui_core::div().child(format!("404: {path}")).into_any_element()
///     })
///     .on_error(|cx, err| {
///         flui_core::div().child(format!("Error: {err}")).into_any_element()
///     });
/// ```
#[must_use]
#[derive(Clone)]
