...
//!
//! ```ignore
//! use flui_navigator::{init_router, Route};
//!
//! init_router(cx, |router| {
//!     router.add_route(Route::new("/", |_, _cx, _params| flui_core::div()));
//! });
//! ```
...
///
/// ```
/// use flui_navigator::NavigationRequest;
///
...
/// init_router(cx, |router| {
///     router.add_route(Route::new("/", |_, _cx, _params| flui_core::div()));
///     router.add_route(Route::new("/users/:id", |_, _cx, _params| flui_core::div()));
/// });
/// ```
...
mod tests {
    use super::*;
    use flui_core::{IntoElement, TestAppContext};
        ...
        cx.update(|cx| {
            init_router(cx, |router| {
                ...
                router.add_route(Route::new(
                    ...
                    |_, _cx, _params| flui_core::div().into_any_element(),
                ));
            });
        });
    ...
    fn test_redirect_loop_protection(cx: &mut TestAppContext) {
        ...
        cx.update(|cx| {
            init_router(cx, |router| {
                ...
                router.add_route(
                    Route::new("/a", |_, _cx, _params| flui_core::div().into_any_element())
                        .guard(guard_fn(|_, _| NavigationAction::redirect("/b"))),
                );
                router.add_route(
                    Route::new("/b", |_, _cx, _params| flui_core::div().into_any_element())
