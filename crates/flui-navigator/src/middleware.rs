...
//!
//! ```no_run
//! use flui_navigator::{RouteMiddleware, NavigationRequest};
//!
//! struct LoggingMiddleware;
//!
//! impl RouteMiddleware for LoggingMiddleware {
//!     fn before_navigation(&self, _cx: &flui_core::App, request: &NavigationRequest) {
//!         println!("Navigating to: {}", request.to);
//!     }
//!
//!     fn after_navigation(&self, _cx: &flui_core::App, request: &NavigationRequest) {
...
///     }
///
///     fn after_navigation(&self, _cx: &flui_core::App, _request: &NavigationRequest) {
...
///
/// ```no_run
/// use flui_navigator::middleware_fn;
///
