...
//! # ;
//! # fn admin_page(_: &mut flui_core::Window, _: &mut flui_core::App, _: &RouteParams) -> flui_core::AnyElement { todo!() }
//! # fn is_logged_in(_: &flui_core::App) -> bool { todo!() }
//! # fn get_user_role(_: &flui_core::App) -> Option<String> { todo!() }
//! ```
//!
//! # Nested Routes
//!
...
//!     ])
//! # ;
//! # fn dashboard_layout(_: &mut flui_core::Window, _: &mut flui_core::App, _: &RouteParams) -> flui_core::AnyElement { todo!() }
//! # fn overview_page(_: &mut flui_core::Window, _: &mut flui_core::App, _: &RouteParams) -> flui_core::AnyElement { todo!() }
//! # fn settings_page(_: &mut flui_core::Window, _: &mut flui_core::App, _: &RouteParams) -> flui_core::AnyElement { todo!() }
//! ```
//!
//! # Feature Flags
//!
...
#![doc(html_root_url = "https://docs.rs/flui_navigator/0.1.4")]
