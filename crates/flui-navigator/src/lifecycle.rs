...
///
/// ```
/// use flui_navigator::NavigationAction;
///
...
///
/// ```no_run
/// use flui_navigator::{RouteLifecycle, NavigationAction, NavigationRequest};
///
...
///     fn on_enter(&self, _cx: &flui_core::App, _request: &NavigationRequest) -> NavigationAction {
///         NavigationAction::Continue
///     }
///
///     fn on_exit(&self, _cx: &flui_core::App) -> NavigationAction {
///         NavigationAction::Continue
///     }
///
///     fn can_deactivate(&self, _cx: &flui_core::App) -> NavigationAction {
...
mod tests {
    ...
    #[flui_core::test]
    fn test_lifecycle_on_enter_continue(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_lifecycle_on_enter_abort(cx: &mut flui_core::TestAppContext) {
        let lifecycle = TestLifecycle {
            should_abort: true,
            should_redirect: false,
        };
    ...
    #[flui_core::test]
    fn test_lifecycle_on_enter_redirect(cx: &mut flui_core::TestAppContext) {
        let lifecycle = TestLifecycle {
            should_abort: false,
    ...
    #[flui_core::test]
    fn test_lifecycle_can_deactivate_allow(cx: &mut flui_core::TestAppContext) {
        let lifecycle = TestLifecycle {
            should_abort: false,
            should_redirect: false,
        };
    ...
    #[flui_core::test]
    fn test_lifecycle_can_deactivate_block(cx: &mut flui_core::TestAppContext) {
        let lifecycle = TestLifecycle {
            should_abort: true,
            should_redirect: false,
        };
