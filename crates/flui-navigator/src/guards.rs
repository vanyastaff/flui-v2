...
//! use flui_navigator::{Route, AuthGuard, RoleGuard, NavigationAction};
//!
//! Route::new("/admin", |_, _cx, _params| flui_core::div().into_any_element())
...
///
/// ```no_run
/// use flui_navigator::{RouteGuard, NavigationAction, NavigationRequest};
///
/// struct MyAuthGuard {
///     redirect_to: String,
/// }
...
///     fn check(&self, _cx: &flui_core::App, _request: &NavigationRequest) -> NavigationAction {
...
///
/// ```no_run
/// use flui_navigator::{guard_fn, NavigationAction};
///
...
/// ```no_run
/// use flui_core::IntoElement;
/// use flui_navigator::{Route, AuthGuard};
///
/// Route::new("/dashboard", |_, _cx, _params| flui_core::div().into_any_element())
...
/// ```no_run
/// use flui_core::IntoElement;
/// use flui_navigator::{Route, RoleGuard};
///
/// Route::new("/admin", |_, _cx, _params| flui_core::div().into_any_element())
///     .guard(RoleGuard::new(
///         |_cx| Some("admin".into()),
...
/// ```no_run
/// use flui_core::IntoElement;
/// use flui_navigator::{Route, PermissionGuard};
///
/// Route::new("/users/:id/delete", |_, _cx, _params| flui_core::div().into_any_element())
...
///
/// ```no_run
/// use flui_navigator::{Guards, AuthGuard, RoleGuard};
///
...
///
/// ```no_run
/// use flui_navigator::{NotGuard, AuthGuard};
///
...
mod tests {
    ...
    #[flui_core::test]
    fn test_auth_guard_allows_authenticated(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_auth_guard_redirects_unauthenticated(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_role_guard_allows_correct_role(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_role_guard_with_redirect(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_role_guard_deny_without_redirect(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_permission_guard_allows(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_permission_guard_denies(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_permission_guard_with_redirect(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_guards_all_pass(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_guards_one_fails(cx: &mut flui_core::TestAppContext) {
        let guards = Guards::builder()
            .guard(AuthGuard::new(|_| true, "/login"))
    ...
    #[flui_core::test]
    fn test_guards_priority_order(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_not_guard_inverts_allow(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_not_guard_inverts_deny(cx: &mut flui_core::TestAppContext) {
    ...
    #[flui_core::test]
    fn test_not_guard_preserves_redirect(cx: &mut flui_core::TestAppContext) {
