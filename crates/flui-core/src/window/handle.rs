//! Window handles — [`WindowId`], [`WindowHandle<V>`], [`AnyWindowHandle`].
//!
//! See spec: `docs/superpowers/specs/2026-05-13-A10-xl-file-split-design.md`
//! (A10a PR 1.1 — handle.rs extraction).
//!
//! # What lives here
//!
...
//!   of the root-view. Cheap to copy; the canonical handle stored on
//!   [`crate::Window`]'s `core.handle` field.
//! - `impl HasWindowHandle for Window` / `impl HasDisplayHandle for Window` —
//!   `raw-window-handle` glue. Implemented here because the implementations
...
impl HasDisplayHandle for Window {
    fn display_handle(
        ...
        self.core.platform_window.display_handle()
    }
}
